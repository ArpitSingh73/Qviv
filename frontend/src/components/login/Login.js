      ...
      <div className="min-h-screen bg-[#071e34] py-6 flex flex-col justify-center sm:py-12">
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
          <div className="relative px-4 py-10  bg-gray-200 shadow-lg sm:rounded-3xl sm:p-20">
            <div
              className="sm:w-60  md:w-96 lg:w-96 mx-auto"
            ...
            >
              ...
              <div className="divide-y divide-gray-200">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  <div className="relative bg-[#071e34] h-16 text-center content-center items-center rounded-lg shadow-lg text-xl font-extrabold  hover:text-red-500  text-red-600 cursor-pointer">
